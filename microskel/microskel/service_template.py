...
class ServiceTemplate:
    ...
    def get_modules(self):  # polymorphic function call
        modules = [microskel.log_call_module.LogCallModule(self.app),
                   ...
                   microskel.consul_module.ConsulModule(self.app),
                   microskel.health_module.HealthModule(),
    ...
    def get_python_modules(self):
        return [microskel.log_call_module, microskel.hello_module, microskel.consul_module, microskel.health_module,
                microskel.db_module, microskel.logging_module, microskel.consul_discovery_module]
